  ...
  return (
    <div className="min-h-screen p-4">
      <div className="max-w-6xl">
        <div className="w-full mt-[-3px] rounded-[16px] p-[2px]">
          <div className="z-30">
            <div className="flex w-full flex-col bg-slate-900 md:flex-row rounded-[16px]">
              
              {/* Left Section - Staking Form */}
              <div className="w-full p-4 text-left md:w-[57%] md:p-12">
              ...
              <div className="w-full p-4 text-left md:w-[43%] md:p-12">
