export default function MyBalances() {
    return (
      <div className="col-span-3 rounded-2xl bg-blue-600 p-6">
        ...
        <div className="scroll1 flex flex-col gap-5 md:max-h-[194px] md:overflow-hidden md:overflow-y-auto">
          {/* ---- ECLIP ---- */}
          <div className="rounded-lg bg-white text-black px-4 py-5 transition-all bg-gradient-secondaryDefault8">
          ...
          {/* Repeat similar JSX for bECLIP, eclipASTRO, ASTRO, etc. */}
        </div>
      </div>
    );
  }
